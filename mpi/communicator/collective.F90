program coll_exer
  ...
  call mpi_bcast(rep, 2*n_mpi_tasks, mpi_integer, 0, mpi_comm_world, ierr)  


  ! Print data that was received
  ! TODO: add correct buffer
  call print_buffers(rep)
  ...
  call mpi_gatherv(sendbuf,rcv(rank+1), mpi_integer, red, rcv, dis,&
                   mpi_integer, 1, mpi_comm_world, ierr) 
  
  call print_buffers(red)
